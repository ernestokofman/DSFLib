package DSFLib
  ...
  "Library of electrical circuit components"
    ...
    package Components "Electrical components"
      ...
      equation
        p.v = 0;
        annotation(
          Icon(coordinateSystem(preserveAspectRatio = true, extent = {{-100, -100}, {100, 100}}), graphics = {Line(origin = {0, -30}, points = {{-60, 50}, {60, 50}}, color = {0, 0, 255}), Line(origin = {0, -30}, points = {{-40, 30}, {40, 30}}, color = {0, 0, 255}), Line(origin = {0, -30}, points = {{-20, 10}, {20, 10}}, color = {0, 0, 255}), Line(origin = {0, -30}, points = {{0, 96}, {0, 50}}, color = {0, 0, 255}), Text(origin = {0, -30}, textColor = {0, 0, 255}, extent = {{-150, -10}, {150, -50}}, textString = "%name")}), Documentation(info="<html>
      ...
      </html>"), Icon(graphics = {Line(points = {{50, 0}, {90, 0}}, color = {0, 0, 255}), Text(textColor = {0, 0, 255}, extent = {{-150, 60}, {150, 100}}, textString = "%name"), Line(points = {{0, -50}, {0, 50}}, color = {0, 0, 255}), Line(points = {{-90, 0}, {-50, 0}}, color = {0, 0, 255}), Text(extent = {{-150, -100}, {150, -60}}, textString = "I=%I"), Ellipse(lineColor = {0, 0, 255}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid, extent = {{-50, 50}, {50, -50}}), Polygon(origin = {44, 0}, rotation = 180, lineColor = {0, 0, 255}, fillColor = {0, 0, 255}, fillPattern = FillPattern.Solid, points = {{90, 0}, {60, 10}, {60, -10}, {90, 0}}), Line(origin = {14, 0}, points = {{-30, 0}, {30, 0}, {30, 0}}, color = {0, 0, 255})}));
      end ConstCurr;
      ...
      </html>"), Icon(graphics = {Ellipse(lineColor = {0, 0, 255}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid, extent = {{-50, 50}, {50, -50}}), Line(points = {{-80, 20}, {-60, 20}}, color = {0, 0, 255}), Text(extent = {{-150, -110}, {150, -70}}, textString = "V=%V"), Line(points = {{60, 20}, {80, 20}}, color = {0, 0, 255}), Text(textColor = {0, 0, 255}, extent = {{-150, 70}, {150, 110}}, textString = "%name"), Line(points = {{-90, 0}, {-50, 0}}, color = {0, 0, 255}), Line(points = {{-50, 0}, {50, 0}}, color = {0, 0, 255}), Line(points = {{50, 0}, {90, 0}}, color = {0, 0, 255}), Line(points = {{-70, 30}, {-70, 10}}, color = {0, 0, 255})}));
      end ConstVolt;
  ...
  "Library of 1-dim. and 2-dim. mechanical components (rotational, translational and planar)"
    ...
    "Library to model 1-dimensional, translational mechanical systems"
      ...
      package Examples
        "Examples that demostrate the usage of the mechanical translational components"
    ...
    "Library to model 1-dimensional, rotational mechanical systems"
      ...
      package Examples
      "Examples that demostrate the usage of the mechanical rotational components"
    ...
    "Library to model roto-translational mechanical systems"
      ...
      package Examples
      "Examples that demostrate the usage of the roto-translational components"
        model RotTrans
      ...
      package Examples "Examples that demostrate the usage of the electromechanical components"
        ...
        model DCMotorSepExc2 "Soft start of separately excitation DC motor"
          ...
          DSFLib.Circuits.Components.ConstVolt Vexc(V = 184) annotation(
            Placement(transformation(origin = {-66, -6}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
        ...
        equation
          connect(motor.p_exc, Vexc.p) annotation(
            Line(points = {{-28, 10}, {-48, 10}, {-48, 4}, {-66, 4}}));
          connect(Vexc.n, motor.n_exc) annotation(
            Line(points = {{-66, -16}, {-66, -22}, {-28, -22}}));
          ...
          annotation(Documentation(info="<html>
        <p>This model uses the DCMotorSepExc component along with a modulated voltage source to implement a soft start mechanism, which helps to avoid current peaks. The excitation circuit is powered by a constant voltage source.</p>
        </html>"),
